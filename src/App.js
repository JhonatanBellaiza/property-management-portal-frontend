          ...
          <Routes>
            ...
            {userType === 'Owner' && (
              <>
                ...
                <Route
                  path="/owner-offer-history"
                  element={<OfferHistoryPage />}
                ></Route>
                <Route
                  path="/owner-live-offers"
                  element={<LiveOfferPage />}
                ></Route>
            ...
            {userType === 'Customer' && (
              <>
                <Route
                  path="/customer-offer-history"
                  element={<CustomerHistoryOffers />}
                ></Route>
                <Route
                  path="/customer-offer-live"
                  element={<CustomerLiveOffers />}
                ></Route>
